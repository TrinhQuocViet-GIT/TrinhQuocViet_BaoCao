        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-end">
                    <div class="">
                        <a class=" btn btn-sm btn-primary" href="{{ route('slider.index') }}"><i
                            ...
                            @foreach ($list as $slider)
                                <tr>
                                    ...
                                    <td> <img width="50px" height="50px"
                                            src="{{ asset('images/slider/' . $slider->link) }}" alt=""> </td>
                                    <td>{{ $slider->name }}</td>
                                    <td>{{ $slider->id }}</td>
                                    <td>
                                        <a class="btn btn-info" href="{{ route('slider.show', ['slider' => $slider->id]) }}"><i
                                                class="fa fa-eye"></i></a>
                                        <a class="btn btn-primary"
                                            href="{{ route('slider.restore', ['slider' => $slider->id]) }}"><i
