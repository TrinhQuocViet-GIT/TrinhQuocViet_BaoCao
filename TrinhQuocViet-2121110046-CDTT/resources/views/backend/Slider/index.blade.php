        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-end">
                    <div class="">
                        <a class=" btn btn-sm btn-primary" href="{{ route('slider.create') }}"><i
                                class="fa fa-plus"></i></a>
                        <a class=" btn btn-sm btn-danger" href="{{ route('slider.trash') }}"> <i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info"
                                            href="{{ route('slider.show', ['slider' => $slider->id]) }}"><i
                                                class="fa fa-eye"></i></a>
                                        <a class="btn btn-success"
                                            href="{{ route('slider.edit', ['slider' => $slider->id]) }}"><i
