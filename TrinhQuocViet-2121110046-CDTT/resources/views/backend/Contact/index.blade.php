        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-end">
                    <div class="">
                        <a class=" btn btn-sm btn-primary" href="{{ route('contact.create') }}"><i
                                class="fa fa-plus"></i>Thêm</a>
                        <a class=" btn btn-sm btn-danger" href="{{ route('contact.trash') }}"> <i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info"
                                            href="{{ route('contact.show', ['contact' => $contact->id]) }}"><i
                                                class="fa fa-eye"></i></a>
                                        <a class="btn btn-success"
                                            href="{{ route('contact.edit', ['contact' => $contact->id]) }}"><i
