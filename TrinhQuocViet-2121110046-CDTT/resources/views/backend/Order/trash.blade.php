        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-end">
                    <div class="">
                        <a class=" btn btn-sm btn-primary" href="{{ route('order.index') }}"><i
                        ...
                        <tbody>
                            @foreach ($list as $order)
                                <tr>
                                    ...
                                    <td>{{ $order->phone }}</td>
                                    <td>
                                        <a class="btn btn-info" href="{{ route('order.show', ['order' => $order->id]) }}"><i
                                                class="fa fa-eye"></i></a>
                                        <a class="btn btn-primary"
                                            href="{{ route('order.restore', ['order' => $order->id]) }}"><i
