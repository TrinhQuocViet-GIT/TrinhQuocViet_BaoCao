            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="">
                            <a class=" btn btn-sm btn-primary" href="{{ route('brand.create') }}"><i
                                    class="fa fa-plus"></i>Thêm</a>
                            <a class=" btn btn-sm btn-danger" href="{{ route('brand.trash') }}"> <i
                                ...
                                @foreach ($list as $brand)
                                    <tr>
                                        ...
                                        <td> <img width="50px" height="50px"
                                                src="{{ asset('images/brand/' . $brand->image) }}" alt=""> </td>
                                        <td>{{ $brand->name }}</td>
                                        <td>{{ $brand->id }}</td>
                                        <td>
                                            @if ($brand->status == 1)
                                            ...
                                            <a class="btn btn-info"
                                                href="{{ route('brand.show', ['brand' => $brand->id]) }}"><i
                                                    class="fa fa-eye"></i></a>
